  ...
  var COMPONENTS = [
{
  ...
  /* Токены идут первыми, компоненты — следом. Порядок групп в сайдбаре
     задаётся этим массивом, а не сортировкой. */
  window.GALLERY = ES.tokenSections(window.BRAND_TOKENS).concat(COMPONENTS);
})();

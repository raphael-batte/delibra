...
window.ENGINE_I18N.en = {
  ...
  'new.bridge.hint':   'A local bridge is answering, so the variables can be read straight into the storybook. Only what is declared as a variable comes through — expect a starting palette, not a finished system.',
  ...
  'new.design.hint':   'A link to the file, page or frame. Optional — it is stored with the storybook and handed to your agent, nothing is fetched.',

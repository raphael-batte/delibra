...
window.ENGINE_I18N.en = {
  ...
  'settings.remove':   'Remove from this gallery',
  'settings.remove.hint': 'The folder on disk stays untouched — this only removes the storybook from your list and forgets its local name and attached CSS. Bring it back from Settings.',

...
(function () {
  ...
  /* ══════════════════════════════════════════════════════════════════════
     ...
     отличается от дизайн-системы (tokens.css + sdm.css). Одну и ту же
  ...
  /* Сравнение НЕ зависит от переключателя вида: держим два собственных
     скрытых фрейма — один с sdm.css, другой со styles.css — и сравниваем их
  ...
  /* Сборка ленивая и по очереди.
     ...
     tokens.css / sdm.css / styles.css. Часть просто не успевала загрузиться,
